// Écouter la fête 'DOMContentLoaded' qui est déclenché lorsque le contenu initial du document HTML a été complètement chargé et analysé
document.addEventListener("DOMContentLoaded", function() {
    // Obtenir l'élément de saisie de fichier et l'élément d'aperçu d'image par leurs identifiants
    var fileInput = document.getElementById('fileInput');
    var imagePreview = document.getElementById('imagePreview');

    // Ajouter un gestionnaire des fêtes pour réagir au changement du champ de saisie de fichier
